...
export default class Room extends Component {
    ...
    async componentDidMount() {
        ...
        this.socket.on('board-update', (position, move) => {
            ...
            if (this.board.current.game.fen() !== position) {
        ...
        this.socket.on('toggle-move', value => {
            console.log("toggle-move recived: " + value)
        ...
        this.socket.on('move-voted', (move) => {
            console.log("user voted move: " + move);
            this.addMoveToProposed("user", move);
        });
                ...
                <div className="roomBoardContainer">
                    <Chessboard ref={this.board} playerColor="none" onMove={(move) => {
                        if (!this.isAdmin && this.voteEnabled) {
                            ...
                            this.socket.emit("vote-move", move);
    ...
    toggleVote() {
        ...
        if (!this.state.isVoteStarted) {
            ...
            this.socket.emit("board-update", this.board.current.game.fen(), null);
            this.showVoteResult();
    ...
    showVoteResult() {
        this.addMoveToProposed("","a7a6")
        this.addMoveToProposed("","a7a6")
        this.addMoveToProposed("","a7a6")
        this.addMoveToProposed("","a7a6")
        this.addMoveToProposed("","g7g6")
        this.addMoveToProposed("","g7g6")
        this.addMoveToProposed("","g7g6")
        this.addMoveToProposed("","b8c6")
        this.addMoveToProposed("","b8c6")
        this.addMoveToProposed("","e7e6")
